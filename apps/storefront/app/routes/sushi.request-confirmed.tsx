    ...
    <Container className="py-16">
      <div className="mx-auto max-w-lg text-center">
        ...
        <p className="mt-4 text-gray-600">
          The chef will review your delivery request and email you a payment link once your delivery fee
          is confirmed. You can complete checkout after you receive that email.
        </p>
        {orderRequestId && (
