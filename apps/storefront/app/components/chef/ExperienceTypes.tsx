...
const experienceTypes: ExperienceType[] = [
  {
    ...
    price: '$99.99',
    description:
      'Perfect for larger gatherings and casual entertaining. Fresh sushi, sashimi, and seasonal bites served buffet-style so guests can mingle and enjoy at their own pace.',
    highlights: [
    ...
    icon: '/assets/images/book_sdoa_experience.jpg',
  ...
  },
  {
    ...
    price: '$119.99',
    description:
      'Beautifully composed sushi bento boxes made with premium fish and fresh ingredients, ready for pickup and perfect for lunch, events, or easy entertaining.',
    highlights: ['Fresh daily ingredients', 'Chef-composed boxes', 'Easy pickup experience', 'Great for groups'],
    icon: '/assets/images/chef_scallops_home.jpg',
  ...
  },
  {
    ...
    price: '$149.99',
    description:
      'An intimate omakase-style dinner prepared in your home with multiple courses, premium ingredients, and careful attention to each guest.',
    highlights: [
    ...
    icon: '/assets/images/IMG_2697.jpg',
      ...
      <div className="text-center space-y-4 flex-grow flex flex-col">
        <div className="w-full h-32 rounded-t-lg overflow-hidden">
          <Image
            ...
            fallbackSrc={['/assets/images/IMG_2697.jpg', '/assets/images/book_sdoa_experience.jpg']}
          />
        </div>
...
function mapApiToLocal(apiTypes: StoreExperienceTypeDTO[]): ExperienceType[] {
  const fallbackImages: Record<string, string> = {
    buffet_style: '/assets/images/book_sdoa_experience.jpg',
    buffet: '/assets/images/book_sdoa_experience.jpg',
    pickup: '/assets/images/IMG_2694.jpg',
    bento: '/assets/images/IMG_2694.jpg',
    bento_box: '/assets/images/IMG_2694.jpg',
    cooking_class: '/assets/images/chef_scallops_home.jpg',
    plated_dinner: '/assets/images/IMG_2697.jpg',
    omakase: '/assets/images/IMG_2697.jpg',
  };
...
export const ExperienceTypes: FC<ExperienceTypesProps> = ({
  ...
  const displayTypes = apiExperienceTypes.length > 0 ? mapApiToLocal(apiExperienceTypes) : experienceTypes;
  ...
  return (
    <Container className={clsx('py-12 lg:py-16', className)}>
      <div className="text-center mb-8 lg:mb-12">
        ...
        <p className="lg:hidden text-primary-600 text-xl">Tap to explore available sushi experiences</p>
      </div>

      {/* Desktop Grid Layout */}
      <div className="hidden lg:grid lg:grid-cols-3 gap-6 lg:gap-8">
        {displayTypes.map((experience, index) => (
          <ExperienceCard key={experience.id} experience={experience} featured={index === 1} />
        ))}
      </div>
      ...
      <div className="lg:hidden pt-2">
        <Accordion.Root type="single" collapsible className="space-y-6">
          {displayTypes.map((experience, index) => (
            <ExperienceAccordionItem key={experience.id} experience={experience} featured={index === 1} />
          ))}
        </Accordion.Root>
      </div>
